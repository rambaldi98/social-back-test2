...
import com.example.models.dto.viewModels.relationship.FriendsAllViewModel;
import com.example.services.RelationshipService;
...
public class RelationshipController {
    ...
    public ResponseEntity removeFriend(@RequestBody Map<String, Object> body) throws Exception {
        ...
        if (result) {
            SuccessResponse successResponse = new SuccessResponse(LocalDateTime.now(), ResponseMessageConstants.SUCCESSFUL_FRIEND_REMOVE_MESSAGE, "", true);
            return new ResponseEntity<>(this.objectMapper.writeValueAsString(successResponse), HttpStatus.OK);
        }
    ...
    public ResponseEntity acceptFriend(@RequestBody Map<String, Object> body) throws Exception {
        ...
        if (result) {
            SuccessResponse successResponse = new SuccessResponse(LocalDateTime.now(), ResponseMessageConstants.SUCCESSFUL_ADDED_FRIEND_MESSAGE, "", true);
            return new ResponseEntity<>(this.objectMapper.writeValueAsString(successResponse), HttpStatus.OK);
        }
        throw new CustomException(ResponseMessageConstants.SERVER_ERROR_MESSAGE);
    }
    ...
    public ResponseEntity cancelFriendshipRequest(@RequestBody Map<String, Object> body) throws Exception {
        ...
        if (result) {
            SuccessResponse successResponse = new SuccessResponse(LocalDateTime.now(), ResponseMessageConstants.SUCCESSFUL_REJECT_FRIEND_REQUEST_MESSAGE, "", true);
            return new ResponseEntity<>(this.objectMapper.writeValueAsString(successResponse), HttpStatus.OK);
        }
