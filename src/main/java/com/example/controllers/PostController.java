...
import com.example.models.dto.viewModels.post.PostAllViewModel;
...
import com.example.models.dto.serviceModels.PostServiceModel;
...
public class PostController {
    ...
    public ResponseEntity<Object> createPost(@RequestBody @Valid PostCreateBindingModel postCreateBindingModel, Authentication principal) throws Exception {
        ...
        if (post) {
            SuccessResponse successResponse = new SuccessResponse(LocalDateTime.now(), ResponseMessageConstants.SUCCESSFUL_CREATE_POST_MESSAGE, " ", true);
    ...
    public ResponseEntity removePost(@RequestBody Map<String, Object> body) throws Exception {
        ...
        if (result.get()) {
            SuccessResponse successResponse = new SuccessResponse(LocalDateTime.now(), ResponseMessageConstants.SUCCESSFUL_POST_DELETE_MESSAGE, "", true);
            return new ResponseEntity<>(this.objectMapper.writeValueAsString(successResponse), HttpStatus.OK);
        }
