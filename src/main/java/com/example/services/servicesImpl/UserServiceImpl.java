...
public class UserServiceImpl implements UserService {
    ...
    public UserServiceModel updateUserOnlineStatus(String userName, boolean changeToOnline) throws Exception {
        User user = this.userRepository.findByUsername(userName)
                ...
                .orElseThrow(() -> new CustomException(ResponseMessageConstants.SERVER_ERROR_MESSAGE));
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        return this.userRepository
                ...
                .filter(userValidation::isValid)
                .orElseThrow(() -> new UsernameNotFoundException(ResponseMessageConstants.USER_NOT_FOUND_ERROR_MESSAGE));
    }
    ...
    public boolean promoteUser(String id) throws Exception {
        ...
        switch (userAuthority) {
            case "USER":
                ...
                break;
            case "ROOT":
                throw new CustomException(ResponseMessageConstants.USER_FAILURE_CHANGING_ROOT_AUTHORITY_MESSAGE);
            default:
                throw new CustomException(ResponseMessageConstants.USER_FAILURE_PROMOTING_ADMIN_MESSAGE);
        }
    ...
    public boolean demoteUser(String id) throws Exception {
        ...
        switch (userAuthority) {
            ...
            case "ROOT":
                throw new CustomException(ResponseMessageConstants.USER_FAILURE_CHANGING_ROOT_AUTHORITY_MESSAGE);
            case "USER":
                throw new CustomException(ResponseMessageConstants.USER_FAILURE_DEMOTING_USER_MESSAGE);
        }
