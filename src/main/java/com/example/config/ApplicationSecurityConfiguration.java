...
import com.example.web.filters.JwtAuthenticationFilter;
import com.example.web.filters.JwtAuthorizationFilter;
...
//        config.setAllowCredentials(true);
        config.setAllowedOriginPatterns(Collections.singletonList("*")); // config tat ca
